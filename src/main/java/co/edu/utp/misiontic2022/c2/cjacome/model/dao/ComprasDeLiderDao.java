...
public class ComprasDeLiderDao {
    public List<ComprasDeLiderVo> lideresQueMasGastan(int limite,String order, String form) throws SQLException {
        ...
        try {
            ...
            var query ="SELECT  l.Nombre||' '||l.Primer_Apellido||' '|| l.Segundo_Apellido LIDER, sum (c.Cantidad*mc.Precio_Unidad)"
            + " VALOR "
            + " FROM Lider l "
